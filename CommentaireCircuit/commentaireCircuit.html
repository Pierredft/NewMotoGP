...
<head>
    ...
    <link rel="stylesheet" href="../CommentaireCircuit/commentaireCircuit.css">
    <link rel="stylesheet" href="../PoliceEcriture/MotoGP1/style.css">
    <link rel="stylesheet" href="../PoliceEcriture/MotoGP4/style.css">
    <title>Commentaire Circuits</title>
</head>

<body>
    <nav>
        <a class="btnRetourAccueil texteMotoGP" href="../DiscutionCircuits/DiscuitionCircuits.html" role="button">Retour au sujet</a>
    </nav>
    ...
    <script src="../CommentaireCircuit/commentaireCircuit.js"></script>
</body>
